...
\section{Emulation des digitalen Computer Control Interface GS232A}
Um den Rotor digital über eine serielle Schnittstelle mit dem Computer steuern zu können, wird das GS232A Interface benötigt welches mit einem 9-Pol DIN-Stecker zum G-5500DC verbunden wird.
\begin{figure}[H]
	\cite{noauthor_yaesu_nodate}
	\centering
...
\end{figure}
Aus finanziellen Gründen wird das GS232A mit einem Arduino Uno und entsprechendem zusätzlicher 
